 ...
 */
#define USB_DRIVER_VERSION 2u /*!< USB_2. */
...
typedef enum
{
    USB_Direction_OUT = 0x00, /*!< USB Direstion: IN.   */
    USB_Direction_IN  = 0x01, /*!< USB Direstion: OUT.  */
...
typedef enum
{
    USB_BufDesp_OddEven_Even = 0x00, /*!< Buffer Descriptor OddEven: Even. */
    USB_BufDesp_OddEven_Odd  = 0x01, /*!< Buffer Descriptor OddEven: Odd.  */
